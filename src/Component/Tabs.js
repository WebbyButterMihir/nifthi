import { list, list2, list3 } from "./data.js";
...
const Reacttabs = () => {
  return (
    <Tabs>
      <TabList className="today text-center d-flex d-inline justify-content-center">
        <Tab>
          <button className="rounded border-bg-primary">TODAY</button>
        </Tab>
